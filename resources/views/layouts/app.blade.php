...
<div x-data="{ open: false }" class="fixed bottom-6 right-6 z-50">
    ...
    <div x-show="open" 
        ...
        <!-- Header -->
        <div class="bg-gradient-to-r from-amber-600 to-amber-700 text-white px-6 py-4 flex justify-between items-center">
            ...
            <button @click="open = false" 
                class="hover:bg-amber-800 p-1 rounded transition-colors duration-200">
