<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto py-8">
        <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
            @csrf
            ...
            <div class="mb-4">
                ...
                <textarea name="deskripsi" id="deskripsi" rows="3" class="w-full border border-gray-300 p-2 rounded" required></textarea>
            </div>

            <div class="mb-4">
                <label for="harga" class="block text-gray-700 font-medium mb-2">Harga</label>
                <input type="number" name="harga" id="harga" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
